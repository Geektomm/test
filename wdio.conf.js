...
exports.config = {
    ...
    specs: [
        ...
        //'./test/resources/features/PasswordMatch.features',
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            ...
            args: ['--window-size=1500,800', '--disable-translate', '--disable-extensions', '--disable-background-networking', '--disable-sync', '--disable-default-apps', '--mute-audio', '--no-first-run', '--disable-prompt-on-repost'],
